...
class Bot(AutoShardedBot):
    ...
    async def on_message(self, msg):
        ...
        if not self.is_ready() or msg.author.bot or not permissions.can_send(msg) or msg.guild is None or msg.author.id in blacklist:
            ...
            if (msg.channel.id is 445658065933434892 or msg.channel.id is 445659536016277514 or msg.channel.id is 510141164179947574) and (msg.attachments or "http" in msg.content) and not msg.author.bot:
