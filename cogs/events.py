...
class Events:
    ...
    async def on_reaction_add(self, reaction, user):
        if (reaction.message.channel.id == 423890150876250122 or reaction.message.channel.id == 444787343593832448) and (reaction.message.attachments or "http" in reaction.message.content) and not user.bot and user.id != reaction.message.author.id and reaction.emoji.id == 507362047059689472:
